...
export default function PdfToJpgPage() {
  ...
  const handleDownload = async (pageNumber: number) => {
      // We need to render this page to a hidden canvas and save it
      // Since react-pdf renders to canvas, we can target the canvas in the DOM?
      // Better: Use pdfjs directly to render to a new canvas in memory
      if (!file) return
